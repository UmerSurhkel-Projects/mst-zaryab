...
const ProfileCard = () => {
    ...
    const [imagePreview, setImagePreview] = useState(userProfile?.imageUrl || images.placeHolder);
    ...
    const handleImageChange = (e) => {
        ...
        if (file && file.type.substr(0, 5) === "image") {
            ...
            setImagePreview(images.placeHolder);
        }
    };
    return (
        <div className="profile-card">
            <div className="profile-cover text-center mb-3">
                <label className="profile-cover-avatar" for="avatar_upload">
                    ...
                    <input type="file" id="avatar_upload" onChange={handleImageChange} />
                ...
                <h5 className="mt-3 profile-name mb-1">{userProfile?.firstName +''+ userProfile?.lastName }</h5>
            ...
            <div className="profile-info">
                ...
                {userProfile?.nickName && <div className="text-center mb-4">
